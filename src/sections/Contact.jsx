  ...
  return (
    <section className="contact-section">
      ...
      <p className="contact-message">
        Feel free to reach out via email or connect with me on GitHub or LinkedIn. I'm always open to chatting about opportunities, collaborations, or anything tech-related!
      </p>
